...
var G__19164 = devtools.prefs.pref.call(null,v);
v = G__19164;
continue;
} else {
return v;
...
}catch (e19167){var _e__18173__auto__ = e19167;
return false;
}})();
...
}catch (e19171){var _e__18173__auto__ = e19171;
return false;
}})();
...
}catch (e19173){var _e__18173__auto__ = e19173;
return false;
}}
}
});
...
var vec__19175 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19175,(0),null);
var name = cljs.core.nth.call(null,vec__19175,(1),null);
...
return cljs.core.some.call(null,(function (p1__19178_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19178_SHARP_);
}),template);
});
