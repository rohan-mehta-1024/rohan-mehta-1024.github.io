...
var G__19853 = devtools.prefs.pref.call(null,v);
v = G__19853;
continue;
} else {
return v;
...
}catch (e19856){var _e__18658__auto__ = e19856;
return false;
}})();
...
}catch (e19860){var _e__18658__auto__ = e19860;
return false;
}})();
...
}catch (e19862){var _e__18658__auto__ = e19862;
return false;
}}
}
});
...
var vec__19864 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19864,(0),null);
var name = cljs.core.nth.call(null,vec__19864,(1),null);
...
return cljs.core.some.call(null,(function (p1__19867_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19867_SHARP_);
}),template);
});
