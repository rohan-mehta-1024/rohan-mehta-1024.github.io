...
var o19059 = temp__5751__auto__;
var temp__5751__auto____$1 = (o19059["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o19060 = temp__5751__auto____$1;
return (o19060["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18166__auto__ = f;
return (o__18166__auto__["toString"]).call(o__18166__auto__);
} else {
return "";
}
}catch (e19061){var _ = e19061;
return "";
}});
...
try{var o__18166__auto___19063 = t;
(o__18166__auto___19063["cljs$lang$ctorPrWriter"]).call(o__18166__auto___19063,t,writer);
}catch (e19062){var __19064 = e19062;
}
...
var char_code = (function (){var o__18166__auto__ = (new String(char$));
return (o__18166__auto__["charCodeAt"]).call(o__18166__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18166__auto__ = String;
return (o__18166__auto__["fromCharCode"]).call(o__18166__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19065 = num_code;
switch (G__19065) {
case (1):
return (185);
...
var o__18166__auto__ = String;
return (o__18166__auto__["fromCharCode"]).call(o__18166__auto__,superscript_code);
});
/**
...
}catch (e19067){var _e__18173__auto__ = e19067;
return false;
}})())){
...
var vec__19068 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19068,(0),null);
...
var or__4126__auto__ = (function (){var temp__5751__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5751__auto__)){
...
if(cljs.core.truth_(temp__5751__auto__)){
var o19071 = temp__5751__auto__;
var temp__5751__auto____$1 = (o19071["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o19072 = temp__5751__auto____$1;
return (o19072["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19075){
var vec__19076 = p__19075;
var ns_detector = cljs.core.nth.call(null,vec__19076,(0),null);
...
var G__19082 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19083 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19082;
remaining_tokens = G__19083;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19073){
var G__19074 = cljs.core.first.call(null,seq19073);
var seq19073__$1 = cljs.core.next.call(null,seq19073);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19074,seq19073__$1);
}));
...
var vec__19087 = cljs.core.split_with.call(null,(function (p1__19086_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19086_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19087,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19087,(1),null);
...
var vec__19093 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19093,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19093,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19096 = cljs.core.rest.call(null,remaining_tokens);
var G__19097 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19096;
name_tokens = G__19097;
continue;
} else {
...
var vec__19100 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19100,(0),null);
var arity = cljs.core.nth.call(null,vec__19100,(1),null);
var vec__19103 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19103,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19103,(1),null);
var vec__19106 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19106,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19106,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19106,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19106,(3),null);
...
var vec__19112 = result;
var munged_ns = cljs.core.nth.call(null,vec__19112,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19112,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19112,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19112,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19112,(4),null);
var arity = cljs.core.nth.call(null,vec__19112,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__19116 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__19116,(0),null);
var args = cljs.core.nth.call(null,vec__19116,(1),null);
var vec__19119 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19119,(0),null);
var name = cljs.core.nth.call(null,vec__19119,(1),null);
...
var G__19122 = (arity + (1));
var G__19123 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19124){
var vec__19125 = p__19124;
var arity = cljs.core.nth.call(null,vec__19125,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19125,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19128_SHARP_){
return cljs.core.get.call(null,arities,p1__19128_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__19129_SHARP_){
return cljs.core.drop.call(null,(2),p1__19129_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___19136 = arguments.length;
var i__4737__auto___19137 = (0);
while(true){
if((i__4737__auto___19137 < len__4736__auto___19136)){
args__4742__auto__.push((arguments[i__4737__auto___19137]));

var G__19138 = (i__4737__auto___19137 + (1));
i__4737__auto___19137 = G__19138;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19132){
var vec__19133 = p__19132;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19133,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19130){
var G__19131 = cljs.core.first.call(null,seq19130);
var seq19130__$1 = cljs.core.next.call(null,seq19130);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19131,seq19130__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19141__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19141__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19141__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19141__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19142 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19142,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19142,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19142,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19142,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19142,(4),null);
var arity = cljs.core.nth.call(null,vec__19142,(5),null);
...
var o__18166__auto__ = f;
return (o__18166__auto__["getBasis"]).call(o__18166__auto__);
});
/**
...
}catch (e19146){var _e__18173__auto__ = e19146;
...
var G__19147 = (obj[cljs.core.first.call(null,path)]);
var G__19148 = cljs.core.rest.call(null,path);
obj = G__19147;
path = G__19148;
continue;
} else {
...
var _STAR_ = (function (accum,p__19149){
var vec__19150 = p__19149;
var bit = cljs.core.nth.call(null,vec__19150,(0),null);
var protocol = cljs.core.nth.call(null,vec__19150,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19153){
...
var selector = cljs.core.nth.call(null,vec__19154,(2),null);
...
var post_process = (function (p__19158){
var vec__19159 = p__19158;
var munged_name = cljs.core.nth.call(null,vec__19159,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19159,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19157_SHARP_){
return (obj[cljs.core.first.call(null,p1__19157_SHARP_)]);
}),sorted_matches);
