...
var G__10484 = devtools.prefs.pref.call(null,v);
v = G__10484;
continue;
} else {
return v;
...
}catch (e10487){var _e__9495__auto__ = e10487;
return false;
}})();
...
}catch (e10491){var _e__9495__auto__ = e10491;
return false;
}})();
...
}catch (e10493){var _e__9495__auto__ = e10493;
return false;
}}
}
});
...
var vec__10495 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10495,(0),null);
var name = cljs.core.nth.call(null,vec__10495,(1),null);
...
return cljs.core.some.call(null,(function (p1__10498_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10498_SHARP_);
}),template);
});
