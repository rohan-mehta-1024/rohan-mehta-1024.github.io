...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10510){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10511,G__10512,seq10510__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10516_SHARP_){
return (!((cljs.core.meta.call(null,p1__10516_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__10517__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10521){var _e__9495__auto__ = e10521;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e10523){var _e__9495__auto__ = e10523;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10525 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10526 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10526);

try{var map__10527 = opts;
var map__10527__$1 = (((((!((map__10527 == null))))?(((((map__10527.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10527.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10527):map__10527);
var markup_db = cljs.core.get.call(null,map__10527__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10525);
}});
...
var temp__5455__auto___10532 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___10532)){
var managed_print_level_10533 = temp__5455__auto___10532;
var _STAR_print_level_STAR__orig_val__10530_10534 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10531_10535 = managed_print_level_10533;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10531_10535);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10529_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10529_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10530_10534);
}} else {
job_fn.call(null);
}
