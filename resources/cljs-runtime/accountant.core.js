...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4115__auto__ = (function (){var fexpr__37967 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__37967.cljs$core$IFn$_invoke$arity$1 ? fexpr__37967.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__37967.call(null,link_target));
})();
if(cljs.core.truth_(and__4115__auto__)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__38048){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38049__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38049__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38049__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__38051 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__38052 = null;
var count__38053 = (0);
var i__38054 = (0);
while(true){
if((i__38054 < count__38053)){
var key = chunk__38052.cljs$core$IIndexed$_nth$arity$2(null,i__38054);
...
var G__38075 = seq__38051;
var G__38076 = chunk__38052;
var G__38077 = count__38053;
var G__38078 = (i__38054 + (1));
seq__38051 = G__38075;
chunk__38052 = G__38076;
count__38053 = G__38077;
i__38054 = G__38078;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38051);
if(temp__5735__auto__){
var seq__38051__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38051__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__38051__$1);
var G__38081 = cljs.core.chunk_rest(seq__38051__$1);
var G__38082 = c__4556__auto__;
var G__38083 = cljs.core.count(c__4556__auto__);
var G__38084 = (0);
seq__38051 = G__38081;
chunk__38052 = G__38082;
count__38053 = G__38083;
i__38054 = G__38084;
continue;
} else {
var key = cljs.core.first(seq__38051__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__38085 = cljs.core.next(seq__38051__$1);
var G__38086 = null;
var G__38087 = (0);
var G__38088 = (0);
seq__38051 = G__38085;
chunk__38052 = G__38086;
count__38053 = G__38087;
i__38054 = G__38088;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38055_SHARP_){
return cljs.core.name(p1__38055_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38056_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__38056_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__38059 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__38059) : accountant.core.nav_handler.call(null,G__38059));
} else {
