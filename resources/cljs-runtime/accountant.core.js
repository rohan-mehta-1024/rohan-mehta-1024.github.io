...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4115__auto__ = (function (){var fexpr__37981 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__37981.cljs$core$IFn$_invoke$arity$1 ? fexpr__37981.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__37981.call(null,link_target));
})();
if(cljs.core.truth_(and__4115__auto__)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__37991){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37992__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37992__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37992__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__37997 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__37998 = null;
var count__37999 = (0);
var i__38000 = (0);
while(true){
if((i__38000 < count__37999)){
var key = chunk__37998.cljs$core$IIndexed$_nth$arity$2(null,i__38000);
...
var G__38052 = seq__37997;
var G__38053 = chunk__37998;
var G__38054 = count__37999;
var G__38055 = (i__38000 + (1));
seq__37997 = G__38052;
chunk__37998 = G__38053;
count__37999 = G__38054;
i__38000 = G__38055;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__37997);
if(temp__5735__auto__){
var seq__37997__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__37997__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__37997__$1);
var G__38056 = cljs.core.chunk_rest(seq__37997__$1);
var G__38057 = c__4556__auto__;
var G__38058 = cljs.core.count(c__4556__auto__);
var G__38059 = (0);
seq__37997 = G__38056;
chunk__37998 = G__38057;
count__37999 = G__38058;
i__38000 = G__38059;
continue;
} else {
var key = cljs.core.first(seq__37997__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__38060 = cljs.core.next(seq__37997__$1);
var G__38061 = null;
var G__38062 = (0);
var G__38063 = (0);
seq__37997 = G__38060;
chunk__37998 = G__38061;
count__37999 = G__38062;
i__38000 = G__38063;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38003_SHARP_){
return cljs.core.name(p1__38003_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38004_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__38004_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__38042 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__38042) : accountant.core.nav_handler.call(null,G__38042));
} else {
