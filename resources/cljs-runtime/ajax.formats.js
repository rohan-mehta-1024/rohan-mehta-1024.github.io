...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__38363){
...
var fexpr__38371 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__38371.cljs$core$IFn$_invoke$arity$1 ? fexpr__38371.cljs$core$IFn$_invoke$arity$1(response) : fexpr__38371.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__38373 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__38373.cljs$core$IFn$_invoke$arity$1 ? fexpr__38373.cljs$core$IFn$_invoke$arity$1(response) : fexpr__38373.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__38374){
...
var request = map__38375__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38375__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
