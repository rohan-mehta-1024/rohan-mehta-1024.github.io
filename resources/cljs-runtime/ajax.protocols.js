...
var ajax$protocols$AjaxResponse$_get_response_header$dyn_38109 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_38109(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_38113 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_38113(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_38114 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_38114(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_38120 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_38120(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k38050,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38050,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__38055){
var vec__38057 = p__38055;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38057,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38057,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38049){
var self__ = this;
var G__38049__$1 = this;
return (new cljs.core.RecordIter((0),G__38049__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38051,other38052){
var self__ = this;
var this38051__$1 = this;
return (((!((other38052 == null)))) && ((this38051__$1.constructor === other38052.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38051__$1.status,other38052.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38051__$1.body,other38052.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38051__$1.status_text,other38052.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38051__$1.headers,other38052.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38051__$1.was_aborted,other38052.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38051__$1.__extmap,other38052.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__38049){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__38065 = cljs.core.keyword_identical_QMARK_;
var expr__38066 = k__4388__auto__;
if(cljs.core.truth_((pred__38065.cljs$core$IFn$_invoke$arity$2 ? pred__38065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__38066) : pred__38065.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__38066)))){
return (new ajax.protocols.Response(G__38049,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38065.cljs$core$IFn$_invoke$arity$2 ? pred__38065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__38066) : pred__38065.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__38066)))){
return (new ajax.protocols.Response(self__.status,G__38049,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38065.cljs$core$IFn$_invoke$arity$2 ? pred__38065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__38066) : pred__38065.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__38066)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__38049,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38065.cljs$core$IFn$_invoke$arity$2 ? pred__38065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__38066) : pred__38065.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__38066)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__38049,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38065.cljs$core$IFn$_invoke$arity$2 ? pred__38065.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__38066) : pred__38065.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__38066)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__38049,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__38049),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__38049){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__38049,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__38053){
var extmap__4419__auto__ = (function (){var G__38068 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38053,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__38053)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38068);
} else {
return G__38068;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__38053),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__38053),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__38053),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__38053),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__38053),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
