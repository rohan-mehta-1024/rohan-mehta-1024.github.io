...
var G__27289 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27289;
continue;
} else {
return ch;
...
var vec__27283 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27283,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27287){
...
return (function() { 
var G__27294__delegate = function (rdr,_){
...
var G__27294 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27301__i = 0, G__27301__a = new Array(arguments.length -  1);
while (G__27301__i < G__27301__a.length) {G__27301__a[G__27301__i] = arguments[G__27301__i + 1]; ++G__27301__i;}
  _ = new cljs.core.IndexedSeq(G__27301__a,0,null);
} 
return G__27294__delegate.call(this,rdr,_);};
G__27294.cljs$lang$maxFixedArity = 1;
G__27294.cljs$lang$applyTo = (function (arglist__27302){
var rdr = cljs.core.first(arglist__27302);
var _ = cljs.core.rest(arglist__27302);
return G__27294__delegate(rdr,_);
});
