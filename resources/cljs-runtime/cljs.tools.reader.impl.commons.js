...
var G__27360 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27360;
continue;
} else {
return ch;
...
var vec__27347 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(0),null);
return (match === s);
});
...
var G__27365 = (i__4737__auto___27363 + (1));
i__4737__auto___27363 = G__27365;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27352){
...
return (function() { 
var G__27367__delegate = function (rdr,_){
...
var G__27367 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27368__i = 0, G__27368__a = new Array(arguments.length -  1);
while (G__27368__i < G__27368__a.length) {G__27368__a[G__27368__i] = arguments[G__27368__i + 1]; ++G__27368__i;}
  _ = new cljs.core.IndexedSeq(G__27368__a,0,null);
} 
return G__27367__delegate.call(this,rdr,_);};
G__27367.cljs$lang$maxFixedArity = 1;
G__27367.cljs$lang$applyTo = (function (arglist__27369){
var rdr = cljs.core.first(arglist__27369);
var _ = cljs.core.rest(arglist__27369);
return G__27367__delegate(rdr,_);
});
