...
var G__27282 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27282;
continue;
} else {
return ch;
...
var vec__27277 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27277,(0),null);
return (match === s);
});
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27281,seq27280__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__27290__delegate = function (rdr,_){
...
var G__27290 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27293__i = 0, G__27293__a = new Array(arguments.length -  1);
while (G__27293__i < G__27293__a.length) {G__27293__a[G__27293__i] = arguments[G__27293__i + 1]; ++G__27293__i;}
  _ = new cljs.core.IndexedSeq(G__27293__a,0,null);
} 
return G__27290__delegate.call(this,rdr,_);};
G__27290.cljs$lang$maxFixedArity = 1;
G__27290.cljs$lang$applyTo = (function (arglist__27295){
var rdr = cljs.core.first(arglist__27295);
var _ = cljs.core.rest(arglist__27295);
return G__27290__delegate(rdr,_);
});
