...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27229 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27229(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27239 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27239(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27242 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27242(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27243 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27243(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27247 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27247(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27250 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27250(reader);
}
});
...
var G__27299 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27300 = s.append(c);
c = G__27299;
s = G__27300;
continue;
}
