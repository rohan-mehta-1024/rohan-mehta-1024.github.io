...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27233 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27233(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27242 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27242(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27245 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27245(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27246 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27246(reader);
}
});
...
var G__27304 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27305 = s.append(c);
c = G__27304;
s = G__27305;
continue;
}
