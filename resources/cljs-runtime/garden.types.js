...
(garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k43351,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43351,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__43356){
var vec__43357 = p__43356;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43357,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43357,(1),null);
...
(garden.types.CSSUnit.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43350){
var self__ = this;
var G__43350__$1 = this;
return (new cljs.core.RecordIter((0),G__43350__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(garden.types.CSSUnit.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43352,other43353){
var self__ = this;
var this43352__$1 = this;
return (((!((other43353 == null)))) && ((this43352__$1.constructor === other43353.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43352__$1.unit,other43353.unit)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43352__$1.magnitude,other43353.magnitude)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43352__$1.__extmap,other43353.__extmap)));
}));
...
(garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__43350){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__43360 = cljs.core.keyword_identical_QMARK_;
var expr__43361 = k__4388__auto__;
if(cljs.core.truth_((pred__43360.cljs$core$IFn$_invoke$arity$2 ? pred__43360.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unit","unit",375175175),expr__43361) : pred__43360.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__43361)))){
return (new garden.types.CSSUnit(G__43350,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43360.cljs$core$IFn$_invoke$arity$2 ? pred__43360.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__43361) : pred__43360.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__43361)))){
return (new garden.types.CSSUnit(self__.unit,G__43350,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__43350),null));
}
}
}));
...
(garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__43350){
var self__ = this;
var this__4379__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__43350,self__.__extmap,self__.__hash));
}));
 ...
 */
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__43354){
var extmap__4419__auto__ = (function (){var G__43363 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43354,new cljs.core.Keyword(null,"unit","unit",375175175),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], 0));
if(cljs.core.record_QMARK_(G__43354)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43363);
} else {
return G__43363;
}
})();
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__43354),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__43354),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k43365,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__43369 = k43365;
...
(garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43364){
var self__ = this;
var G__43364__$1 = this;
return (new cljs.core.RecordIter((0),G__43364__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(garden.types.CSSFunction.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43366,other43367){
var self__ = this;
var this43366__$1 = this;
return (((!((other43367 == null)))) && ((this43366__$1.constructor === other43367.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43366__$1.f,other43367.f)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43366__$1.args,other43367.args)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43366__$1.__extmap,other43367.__extmap)));
}));
...
(garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__43364){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__43374 = cljs.core.keyword_identical_QMARK_;
var expr__43375 = k__4388__auto__;
if(cljs.core.truth_((pred__43374.cljs$core$IFn$_invoke$arity$2 ? pred__43374.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__43375) : pred__43374.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__43375)))){
return (new garden.types.CSSFunction(G__43364,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43374.cljs$core$IFn$_invoke$arity$2 ? pred__43374.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"args","args",1315556576),expr__43375) : pred__43374.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__43375)))){
return (new garden.types.CSSFunction(self__.f,G__43364,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.f,self__.args,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__43364),null));
}
}
}));
...
(garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__43364){
var self__ = this;
var this__4379__auto____$1 = this;
return (new garden.types.CSSFunction(self__.f,self__.args,G__43364,self__.__extmap,self__.__hash));
}));
 ...
 */
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__43368){
var extmap__4419__auto__ = (function (){var G__43377 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43368,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"args","args",1315556576)], 0));
if(cljs.core.record_QMARK_(G__43368)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43377);
} else {
return G__43377;
}
})();
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__43368),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__43368),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k43379,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__43383 = k43379;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43379,else__4383__auto__);
...
var self__ = this;
var this__4399__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__43384){
var vec__43385 = p__43384;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43385,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43385,(1),null);
return (f__4400__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4400__auto__.cljs$core$IFn$_invoke$arity$3(ret__4402__auto__,k__4403__auto__,v__4404__auto__) : f__4400__auto__.call(null,ret__4402__auto__,k__4403__auto__,v__4404__auto__));
}),init__4401__auto__,this__4399__auto____$1);
}));
...
(garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__43378){
var self__ = this;
var G__43378__$1 = this;
return (new cljs.core.RecordIter((0),G__43378__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(garden.types.CSSAtRule.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43380,other43381){
var self__ = this;
var this43380__$1 = this;
return (((!((other43381 == null)))) && ((this43380__$1.constructor === other43381.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43380__$1.identifier,other43381.identifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43380__$1.value,other43381.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43380__$1.__extmap,other43381.__extmap)));
}));
...
(garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__43378){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__43397 = cljs.core.keyword_identical_QMARK_;
var expr__43398 = k__4388__auto__;
if(cljs.core.truth_((pred__43397.cljs$core$IFn$_invoke$arity$2 ? pred__43397.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__43398) : pred__43397.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__43398)))){
return (new garden.types.CSSAtRule(G__43378,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43397.cljs$core$IFn$_invoke$arity$2 ? pred__43397.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__43398) : pred__43397.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__43398)))){
return (new garden.types.CSSAtRule(self__.identifier,G__43378,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__43378),null));
}
}
}));
...
(garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__43378){
var self__ = this;
var this__4379__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__43378,self__.__extmap,self__.__hash));
}));
 ...
 */
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__43382){
var extmap__4419__auto__ = (function (){var G__43404 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43382,new cljs.core.Keyword(null,"identifier","identifier",-805503498),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"value","value",305978217)], 0));
if(cljs.core.record_QMARK_(G__43382)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43404);
} else {
return G__43404;
}
})();
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__43382),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__43382),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
