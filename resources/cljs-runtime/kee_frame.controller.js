...
var map__41684 = cljs.core.deref(kee_frame.state.debug_config);
...
var controllers_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41684__$1,new cljs.core.Keyword(null,"controllers?","controllers?",-2009030071),true);
...
kee_frame.controller.process_controller = (function kee_frame$controller$process_controller(id,p__41705,ctx,route){
...
var last_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41706__$1,new cljs.core.Keyword(null,"last-params","last-params",1293824707));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41706__$1,new cljs.core.Keyword(null,"params","params",710516235));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41706__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41706__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current_params = kee_frame.controller.process_params(params,route);
var last_params_41746__$1 = last_params;
var current_params_41747__$1 = current_params;
var ocr_41711_41748 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(last_params_41746__$1,current_params_41747__$1);
try{if((ocr_41711_41748 === true)){
} else {
...
try{if((ocr_41711_41748 === false)){
try{if((last_params_41746__$1 === null)){
kee_frame.controller.start_BANG_(id,ctx,start,current_params_41747__$1);
} else {
throw cljs.core.match.backtrack;

}
}catch (e41731){if((e41731 instanceof Error)){
var e__40585__auto___41750__$1 = e41731;
if((e__40585__auto___41750__$1 === cljs.core.match.backtrack)){
try{if((current_params_41747__$1 === null)){
...
var e__40585__auto___41751__$2 = e41732;
if((e__40585__auto___41751__$2 === cljs.core.match.backtrack)){
kee_frame.controller.stop_BANG_(id,ctx,stop);

kee_frame.controller.start_BANG_(id,ctx,start,current_params_41747__$1);
} else {
throw e__40585__auto___41751__$2;
}
} else {
throw e41732;
...
throw e__40585__auto___41750__$1;
}
} else {
throw e41731;
...
var e__40585__auto___41752__$1 = e41730;
if((e__40585__auto___41752__$1 === cljs.core.match.backtrack)){
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(last_params_41746__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_params_41747__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(ocr_41711_41748)].join('')));
} else {
throw e__40585__auto___41752__$1;
}
} else {
throw e41730;
