...
var map__41673 = cljs.core.deref(kee_frame.state.debug_config);
...
var controllers_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41673__$1,new cljs.core.Keyword(null,"controllers?","controllers?",-2009030071),true);
...
kee_frame.controller.process_controller = (function kee_frame$controller$process_controller(id,p__41686,ctx,route){
var map__41687 = p__41686;
var map__41687__$1 = (((((!((map__41687 == null))))?(((((map__41687.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41687.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41687):map__41687);
var last_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41687__$1,new cljs.core.Keyword(null,"last-params","last-params",1293824707));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41687__$1,new cljs.core.Keyword(null,"params","params",710516235));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41687__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41687__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
...
var ocr_41689_41739 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(last_params_41737__$1,current_params_41738__$1);
try{if((ocr_41689_41739 === true)){
} else {
throw cljs.core.match.backtrack;

}
}catch (e41720){if((e41720 instanceof Error)){
var e__40579__auto___41740 = e41720;
if((e__40579__auto___41740 === cljs.core.match.backtrack)){
try{if((ocr_41689_41739 === false)){
...
var e__40579__auto___41741__$1 = e41724;
if((e__40579__auto___41741__$1 === cljs.core.match.backtrack)){
...
var e__40579__auto___41742__$2 = e41726;
if((e__40579__auto___41742__$2 === cljs.core.match.backtrack)){
kee_frame.controller.stop_BANG_(id,ctx,stop);

kee_frame.controller.start_BANG_(id,ctx,start,current_params_41738__$1);
} else {
throw e__40579__auto___41742__$2;
}
} else {
throw e41726;
...
throw e__40579__auto___41741__$1;
}
} else {
throw e41724;
...
var e__40579__auto___41743__$1 = e41721;
if((e__40579__auto___41743__$1 === cljs.core.match.backtrack)){
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(last_params_41737__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_params_41738__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(ocr_41689_41739)].join('')));
} else {
throw e__40579__auto___41743__$1;
}
} else {
throw e41721;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41730){
var vec__41731 = p__41730;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41731,(0),null);
var controller = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41731,(1),null);
