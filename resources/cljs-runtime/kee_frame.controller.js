...
var map__41714 = cljs.core.deref(kee_frame.state.debug_config);
...
var controllers_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41714__$1,new cljs.core.Keyword(null,"controllers?","controllers?",-2009030071),true);
...
kee_frame.controller.process_controller = (function kee_frame$controller$process_controller(id,p__41716,ctx,route){
...
var last_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41717__$1,new cljs.core.Keyword(null,"last-params","last-params",1293824707));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41717__$1,new cljs.core.Keyword(null,"params","params",710516235));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41717__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41717__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
var current_params = kee_frame.controller.process_params(params,route);
var last_params_41752__$1 = last_params;
var current_params_41753__$1 = current_params;
var ocr_41730_41754 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(last_params_41752__$1,current_params_41753__$1);
try{if((ocr_41730_41754 === true)){
} else {
throw cljs.core.match.backtrack;

}
}catch (e41741){if((e41741 instanceof Error)){
var e__40616__auto___41756 = e41741;
if((e__40616__auto___41756 === cljs.core.match.backtrack)){
try{if((ocr_41730_41754 === false)){
try{if((last_params_41752__$1 === null)){
kee_frame.controller.start_BANG_(id,ctx,start,current_params_41753__$1);
} else {
throw cljs.core.match.backtrack;

}
}catch (e41743){if((e41743 instanceof Error)){
var e__40616__auto___41757__$1 = e41743;
if((e__40616__auto___41757__$1 === cljs.core.match.backtrack)){
try{if((current_params_41753__$1 === null)){
...
var e__40616__auto___41758__$2 = e41744;
if((e__40616__auto___41758__$2 === cljs.core.match.backtrack)){
kee_frame.controller.stop_BANG_(id,ctx,stop);

kee_frame.controller.start_BANG_(id,ctx,start,current_params_41753__$1);
} else {
throw e__40616__auto___41758__$2;
}
} else {
throw e41744;
...
throw e__40616__auto___41757__$1;
}
} else {
throw e41743;
...
var e__40616__auto___41759__$1 = e41742;
if((e__40616__auto___41759__$1 === cljs.core.match.backtrack)){
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(last_params_41752__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_params_41753__$1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(ocr_41730_41754)].join('')));
} else {
throw e__40616__auto___41759__$1;
}
} else {
throw e41742;
