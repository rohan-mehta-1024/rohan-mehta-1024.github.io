...
kee_frame.debug.debug_enabled_QMARK_ = (function kee_frame$debug$debug_enabled_QMARK_(p__42947){
var vec__42948 = p__42947;
var event_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42948,(0),null);
var map__42951 = cljs.core.deref(kee_frame.state.debug_config);
...
var blacklist = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42951__$1,new cljs.core.Keyword(null,"blacklist","blacklist",1248093170));
var events_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42951__$1,new cljs.core.Keyword(null,"events?","events?",-780512682),true);
...
var vec__42978_42985 = clojure.data.diff(orig_db,new_db);
var only_before_42986 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42978_42985,(0),null);
var only_after_42987 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42978_42985,(1),null);
var db_changed_QMARK__42988 = (((!((only_before_42986 == null)))) || ((!((only_after_42987 == null)))));
if(db_changed_QMARK__42988){
...
re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"log","log",-1595516004),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_42986], 0));

re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"log","log",-1595516004),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_42987], 0));
