...
var next_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41556__$1,new cljs.core.Keyword(null,"to","to",192099007));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41556__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
if(cljs.core.truth_(dispatch)){
var seq__41558_41647 = cljs.core.seq(dispatch);
var chunk__41559_41648 = null;
var count__41560_41649 = (0);
var i__41561_41650 = (0);
while(true){
if((i__41561_41650 < count__41560_41649)){
var e_41651 = chunk__41559_41648.cljs$core$IIndexed$_nth$arity$2(null,i__41561_41650);
re_frame.core.dispatch(e_41651);


var G__41652 = seq__41558_41647;
var G__41653 = chunk__41559_41648;
var G__41654 = count__41560_41649;
var G__41655 = (i__41561_41650 + (1));
seq__41558_41647 = G__41652;
chunk__41559_41648 = G__41653;
count__41560_41649 = G__41654;
i__41561_41650 = G__41655;
continue;
} else {
var temp__5735__auto___41656__$1 = cljs.core.seq(seq__41558_41647);
if(temp__5735__auto___41656__$1){
var seq__41558_41657__$1 = temp__5735__auto___41656__$1;
if(cljs.core.chunked_seq_QMARK_(seq__41558_41657__$1)){
var c__4556__auto___41658 = cljs.core.chunk_first(seq__41558_41657__$1);
var G__41659 = cljs.core.chunk_rest(seq__41558_41657__$1);
var G__41660 = c__4556__auto___41658;
var G__41661 = cljs.core.count(c__4556__auto___41658);
var G__41662 = (0);
seq__41558_41647 = G__41659;
chunk__41559_41648 = G__41660;
count__41560_41649 = G__41661;
i__41561_41650 = G__41662;
continue;
} else {
var e_41664 = cljs.core.first(seq__41558_41657__$1);
re_frame.core.dispatch(e_41664);


var G__41665 = cljs.core.next(seq__41558_41657__$1);
var G__41666 = null;
var G__41667 = (0);
var G__41668 = (0);
seq__41558_41647 = G__41665;
chunk__41559_41648 = G__41666;
count__41560_41649 = G__41667;
i__41561_41650 = G__41668;
continue;
}
} else {
}
...
kee_frame.fsm.alpha.foreign_event_QMARK_ = (function kee_frame$fsm$alpha$foreign_event_QMARK_(fsm_id,p__41566){
var vec__41567 = p__41566;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41567,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41567,(1),null);
var event_fsm_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41567,(2),null);
var and__4115__auto__ = (function (){var fexpr__41572 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("kee-frame.fsm.alpha","timeout","kee-frame.fsm.alpha/timeout",659648007),null,new cljs.core.Keyword("kee-frame.fsm.alpha","on-enter","kee-frame.fsm.alpha/on-enter",160434331),null], null), null);
return (fexpr__41572.cljs$core$IFn$_invoke$arity$1 ? fexpr__41572.cljs$core$IFn$_invoke$arity$1(event_id) : fexpr__41572.call(null,event_id));
})();
...
var state_attr = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41575__$1,new cljs.core.Keyword(null,"state-attr","state-attr",680371634),new cljs.core.Keyword("kee-frame.fsm.alpha","state","kee-frame.fsm.alpha/state",-928134116));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41575__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var transition_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41575__$1,new cljs.core.Keyword(null,"fsm","fsm",937922990));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41579){
var vec__41580 = p__41579;
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41580,(0),null);
var transitions = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41580,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__41583,_){
var vec__41584 = p__41583;
var vec__41587 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41584,(0),null);
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41587,(0),null);
var timeout = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41587,(1),null);
...
var seq__41601_41686 = cljs.core.seq(cljs.core.deref(timeouts_STAR_));
var chunk__41602_41687 = null;
var count__41603_41688 = (0);
var i__41604_41689 = (0);
while(true){
if((i__41604_41689 < count__41603_41688)){
var t_41690 = chunk__41602_41687.cljs$core$IIndexed$_nth$arity$2(null,i__41604_41689);
kee_frame.interop.clear_timeout(t_41690);


var G__41691 = seq__41601_41686;
var G__41692 = chunk__41602_41687;
var G__41693 = count__41603_41688;
var G__41694 = (i__41604_41689 + (1));
seq__41601_41686 = G__41691;
chunk__41602_41687 = G__41692;
count__41603_41688 = G__41693;
i__41604_41689 = G__41694;
continue;
} else {
var temp__5735__auto___41695 = cljs.core.seq(seq__41601_41686);
if(temp__5735__auto___41695){
var seq__41601_41696__$1 = temp__5735__auto___41695;
if(cljs.core.chunked_seq_QMARK_(seq__41601_41696__$1)){
var c__4556__auto___41697 = cljs.core.chunk_first(seq__41601_41696__$1);
var G__41698 = cljs.core.chunk_rest(seq__41601_41696__$1);
var G__41699 = c__4556__auto___41697;
var G__41700 = cljs.core.count(c__4556__auto___41697);
var G__41701 = (0);
seq__41601_41686 = G__41698;
chunk__41602_41687 = G__41699;
count__41603_41688 = G__41700;
i__41604_41689 = G__41701;
continue;
} else {
var t_41724 = cljs.core.first(seq__41601_41696__$1);
kee_frame.interop.clear_timeout(t_41724);


var G__41725 = cljs.core.next(seq__41601_41696__$1);
var G__41726 = null;
var G__41727 = (0);
var G__41728 = (0);
seq__41601_41686 = G__41725;
chunk__41602_41687 = G__41726;
count__41603_41688 = G__41727;
i__41604_41689 = G__41728;
continue;
}
} else {
}
...
re_frame.core.reg_fx(new cljs.core.Keyword("kee-frame.fsm.alpha","stop","kee-frame.fsm.alpha/stop",-1038449025),(function (p__41617){
var map__41618 = p__41617;
var map__41618__$1 = (((((!((map__41618 == null))))?(((((map__41618.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41618.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41618):map__41618);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41618__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("kee-frame.fsm.alpha","start","kee-frame.fsm.alpha/start",-1432048294),(function (_,p__41620){
var vec__41621 = p__41620;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41621,(0),null);
var fsm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41621,(1),null);
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41636 = cljs.core.get_global_hierarchy;
return (fexpr__41636.cljs$core$IFn$_invoke$arity$0 ? fexpr__41636.cljs$core$IFn$_invoke$arity$0() : fexpr__41636.call(null));
})());
...
var c__36560__auto___41744 = temp__5739__auto___41743;
if((with_let41639.generation === c__36560__auto___41744.ratomGeneration)){
...
(with_let41639.generation = c__36560__auto___41744.ratomGeneration);
}
...
var destroy__36559__auto___41745 = (function (){
...
(with_let41639.destroy = destroy__36559__auto___41745);
} else {
}
} else {
destroy__36559__auto___41745();
}
