...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(transitions,event,(function (){var G__41537 = transitions;
var G__41538 = cljs.core.butlast(event);
return (kee_frame.fsm.alpha.find_transition.cljs$core$IFn$_invoke$arity$2 ? kee_frame.fsm.alpha.find_transition.cljs$core$IFn$_invoke$arity$2(G__41537,G__41538) : kee_frame.fsm.alpha.find_transition.call(null,G__41537,G__41538));
})());
} else {
return null;
}
...
var seq__41546_41645 = cljs.core.seq(dispatch);
var chunk__41547_41646 = null;
var count__41548_41647 = (0);
var i__41549_41648 = (0);
while(true){
if((i__41549_41648 < count__41548_41647)){
var e_41649 = chunk__41547_41646.cljs$core$IIndexed$_nth$arity$2(null,i__41549_41648);
re_frame.core.dispatch(e_41649);


var G__41650 = seq__41546_41645;
var G__41651 = chunk__41547_41646;
var G__41652 = count__41548_41647;
var G__41653 = (i__41549_41648 + (1));
seq__41546_41645 = G__41650;
chunk__41547_41646 = G__41651;
count__41548_41647 = G__41652;
i__41549_41648 = G__41653;
continue;
} else {
var temp__5735__auto___41654__$1 = cljs.core.seq(seq__41546_41645);
if(temp__5735__auto___41654__$1){
var seq__41546_41655__$1 = temp__5735__auto___41654__$1;
if(cljs.core.chunked_seq_QMARK_(seq__41546_41655__$1)){
var c__4556__auto___41656 = cljs.core.chunk_first(seq__41546_41655__$1);
var G__41676 = cljs.core.chunk_rest(seq__41546_41655__$1);
var G__41677 = c__4556__auto___41656;
var G__41678 = cljs.core.count(c__4556__auto___41656);
var G__41679 = (0);
seq__41546_41645 = G__41676;
chunk__41547_41646 = G__41677;
count__41548_41647 = G__41678;
i__41549_41648 = G__41679;
continue;
} else {
var e_41680 = cljs.core.first(seq__41546_41655__$1);
re_frame.core.dispatch(e_41680);


var G__41681 = cljs.core.next(seq__41546_41655__$1);
var G__41682 = null;
var G__41683 = (0);
var G__41684 = (0);
seq__41546_41645 = G__41681;
chunk__41547_41646 = G__41682;
count__41548_41647 = G__41683;
i__41549_41648 = G__41684;
continue;
}
} else {
}
...
var G__41725__delegate = function (fsm,_){
...
var G__41725 = function (fsm,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41726__i = 0, G__41726__a = new Array(arguments.length -  1);
while (G__41726__i < G__41726__a.length) {G__41726__a[G__41726__i] = arguments[G__41726__i + 1]; ++G__41726__i;}
  _ = new cljs.core.IndexedSeq(G__41726__a,0,null);
} 
return G__41725__delegate.call(this,fsm,_);};
G__41725.cljs$lang$maxFixedArity = 1;
G__41725.cljs$lang$applyTo = (function (arglist__41727){
var fsm = cljs.core.first(arglist__41727);
var _ = cljs.core.rest(arglist__41727);
return G__41725__delegate(fsm,_);
});
...
var with_let41638 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let41638","with-let41638",-1771951301));
var temp__5739__auto___41728 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___41728 == null)){
} else {
var c__36564__auto___41729 = temp__5739__auto___41728;
if((with_let41638.generation === c__36564__auto___41729.ratomGeneration)){
...
(with_let41638.generation = c__36564__auto___41729.ratomGeneration);
}


var init41639 = (with_let41638.length === (0));
var _ = ((init41639)?(with_let41638[(0)] = re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("kee-frame.fsm.alpha","start","kee-frame.fsm.alpha/start",-1432048294),fsm], null))):(with_let41638[(0)]));
...
var destroy__36563__auto___41730 = (function (){
...
if((with_let41638.destroy == null)){
(with_let41638.destroy = destroy__36563__auto___41730);
} else {
}
} else {
destroy__36563__auto___41730();
}
...
var len__4736__auto___41731 = arguments.length;
var i__4737__auto___41732 = (0);
while(true){
if((i__4737__auto___41732 < len__4736__auto___41731)){
args__4742__auto__.push((arguments[i__4737__auto___41732]));

var G__41733 = (i__4737__auto___41732 + (1));
i__4737__auto___41732 = G__41733;
continue;
} else {
}
break;
...
/** @this {Function} */
(kee_frame.fsm.alpha.render.cljs$lang$applyTo = (function (seq41641){
