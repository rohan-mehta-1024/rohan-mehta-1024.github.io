...
var vec__43156 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(clojure.string.replace(url,/^\/#\//,"/"),/#/,(2));
var path_PLUS_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43156,(0),null);
var fragment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43156,(1),null);
var vec__43159 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(path_PLUS_query,/\?/,(2));
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43159,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43159,(1),null);
var G__43162 = reitit.core.match_by_path(routes,path);
if((G__43162 == null)){
return null;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__43162,new cljs.core.Keyword(null,"query-string","query-string",-1018845061),query,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash","hash",-13781596),fragment], 0));
}
});
...
(kee_frame.router.ReititRouter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k43164,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43164,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__43171){
var vec__43172 = p__43171;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43172,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43172,(1),null);
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43165,other43166){
var self__ = this;
var this43165__$1 = this;
return (((!((other43166 == null)))) && ((this43165__$1.constructor === other43166.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43165__$1.routes,other43166.routes)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43165__$1.hash_QMARK_,other43166.hash_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43165__$1.not_found,other43166.not_found)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43165__$1.__extmap,other43166.__extmap)));
}));
...
var or__4126__auto____$1 = (function (){var G__43176 = self__.not_found;
if((G__43176 == null)){
return null;
} else {
return kee_frame.router.match_url(self__.routes,G__43176);
}
})();
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__43163){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__43177 = cljs.core.keyword_identical_QMARK_;
var expr__43178 = k__4388__auto__;
if(cljs.core.truth_((pred__43177.cljs$core$IFn$_invoke$arity$2 ? pred__43177.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"routes","routes",457900162),expr__43178) : pred__43177.call(null,new cljs.core.Keyword(null,"routes","routes",457900162),expr__43178)))){
return (new kee_frame.router.ReititRouter(G__43163,self__.hash_QMARK_,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43177.cljs$core$IFn$_invoke$arity$2 ? pred__43177.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43178) : pred__43177.call(null,new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43178)))){
return (new kee_frame.router.ReititRouter(self__.routes,G__43163,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43177.cljs$core$IFn$_invoke$arity$2 ? pred__43177.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43178) : pred__43177.call(null,new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43178)))){
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,G__43163,self__.__meta,self__.__extmap,null));
} else {
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,self__.not_found,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__43163),null));
}
}
}
}));
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__43163){
var self__ = this;
var this__4379__auto____$1 = this;
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,self__.not_found,G__43163,self__.__extmap,self__.__hash));
}));
 ...
 */
kee_frame.router.map__GT_ReititRouter = (function kee_frame$router$map__GT_ReititRouter(G__43168){
var extmap__4419__auto__ = (function (){var G__43184 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43168,new cljs.core.Keyword(null,"routes","routes",457900162),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash?","hash?",-1899275922),new cljs.core.Keyword(null,"not-found","not-found",-629079980)], 0));
if(cljs.core.record_QMARK_(G__43168)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43184);
} else {
return G__43184;
}
})();
return (new kee_frame.router.ReititRouter(new cljs.core.Keyword(null,"routes","routes",457900162).cljs$core$IFn$_invoke$arity$1(G__43168),new cljs.core.Keyword(null,"hash?","hash?",-1899275922).cljs$core$IFn$_invoke$arity$1(G__43168),new cljs.core.Keyword(null,"not-found","not-found",-629079980).cljs$core$IFn$_invoke$arity$1(G__43168),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var len__4736__auto___43283 = arguments.length;
var i__4737__auto___43284 = (0);
while(true){
if((i__4737__auto___43284 < len__4736__auto___43283)){
args__4742__auto__.push((arguments[i__4737__auto___43284]));

var G__43285 = (i__4737__auto___43284 + (1));
i__4737__auto___43284 = G__43285;
continue;
} else {
}
break;
...
var G__43286 = rest_pairs__$1;
G__43212__$1 = G__43286;
continue;
}
} else {
