...
var or__4126__auto____$1 = (function (){var G__43175 = self__.not_found;
if((G__43175 == null)){
return null;
} else {
return kee_frame.router.match_url(self__.routes,G__43175);
}
})();
...
var expr__43177 = k__4388__auto__;
if(cljs.core.truth_((pred__43176.cljs$core$IFn$_invoke$arity$2 ? pred__43176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"routes","routes",457900162),expr__43177) : pred__43176.call(null,new cljs.core.Keyword(null,"routes","routes",457900162),expr__43177)))){
return (new kee_frame.router.ReititRouter(G__43162,self__.hash_QMARK_,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43176.cljs$core$IFn$_invoke$arity$2 ? pred__43176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43177) : pred__43176.call(null,new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43177)))){
return (new kee_frame.router.ReititRouter(self__.routes,G__43162,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43176.cljs$core$IFn$_invoke$arity$2 ? pred__43176.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43177) : pred__43176.call(null,new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43177)))){
...
var extmap__4419__auto__ = (function (){var G__43181 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43166,new cljs.core.Keyword(null,"routes","routes",457900162),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash?","hash?",-1899275922),new cljs.core.Keyword(null,"not-found","not-found",-629079980)], 0));
if(cljs.core.record_QMARK_(G__43166)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43181);
} else {
return G__43181;
}
})();
...
var config_43286__$1 = ((cljs.core.boolean_QMARK_(screen))?null:screen);
if(cljs.core.truth_(cljs.core.deref(kee_frame.state.breakpoints_initialized_QMARK_))){
kee_frame.interop.set_breakpoint_subs(config_43286__$1);
} else {
kee_frame.interop.set_breakpoints(config_43286__$1);
...
var len__4736__auto___43287 = arguments.length;
var i__4737__auto___43288 = (0);
while(true){
if((i__4737__auto___43288 < len__4736__auto___43287)){
args__4742__auto__.push((arguments[i__4737__auto___43288]));

var G__43289 = (i__4737__auto___43288 + (1));
i__4737__auto___43288 = G__43289;
continue;
} else {
}
break;
...
var G__43295 = rest_pairs__$1;
G__43213__$1 = G__43295;
continue;
}
} else {
