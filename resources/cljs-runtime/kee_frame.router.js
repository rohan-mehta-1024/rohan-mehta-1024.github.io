...
var expr__43181 = k__4388__auto__;
if(cljs.core.truth_((pred__43180.cljs$core$IFn$_invoke$arity$2 ? pred__43180.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"routes","routes",457900162),expr__43181) : pred__43180.call(null,new cljs.core.Keyword(null,"routes","routes",457900162),expr__43181)))){
return (new kee_frame.router.ReititRouter(G__43161,self__.hash_QMARK_,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43180.cljs$core$IFn$_invoke$arity$2 ? pred__43180.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43181) : pred__43180.call(null,new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43181)))){
return (new kee_frame.router.ReititRouter(self__.routes,G__43161,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43180.cljs$core$IFn$_invoke$arity$2 ? pred__43180.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43181) : pred__43180.call(null,new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43181)))){
...
var extmap__4419__auto__ = (function (){var G__43183 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43165,new cljs.core.Keyword(null,"routes","routes",457900162),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash?","hash?",-1899275922),new cljs.core.Keyword(null,"not-found","not-found",-629079980)], 0));
if(cljs.core.record_QMARK_(G__43165)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43183);
} else {
return G__43183;
}
})();
...
kee_frame.router.bootstrap_routes = (function kee_frame$router$bootstrap_routes(p__43185){
var map__43186 = p__43185;
var map__43186__$1 = (((((!((map__43186 == null))))?(((((map__43186.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43186.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__43186):map__43186);
var routes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43186__$1,new cljs.core.Keyword(null,"routes","routes",457900162));
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43186__$1,new cljs.core.Keyword(null,"router","router",1091916230));
var hash_routing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43186__$1,new cljs.core.Keyword(null,"hash-routing?","hash-routing?",471914732));
var scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43186__$1,new cljs.core.Keyword(null,"scroll","scroll",971553779));
var route_change_event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43186__$1,new cljs.core.Keyword(null,"route-change-event","route-change-event",1834214120));
var not_found = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43186__$1,new cljs.core.Keyword(null,"not-found","not-found",-629079980));
...
var map__43193 = cljs.core.deref(kee_frame.state.debug_config);
...
var routes_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43193__$1,new cljs.core.Keyword(null,"routes?","routes?",-1257506224),true);
...
var ctx = map__43197__$1;
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43197__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43198 = p__43196;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43198,(0),null);
var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43198,(1),null);
if(cljs.core.truth_(scroll)){
...
var G__43284 = rest_pairs__$1;
G__43212__$1 = G__43284;
continue;
}
} else {
