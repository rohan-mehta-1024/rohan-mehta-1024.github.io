...
var vec__43151 = route;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43151,(0),null);
var path_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43151,(1),null);
...
var vec__43154 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(clojure.string.replace(url,/^\/#\//,"/"),/#/,(2));
var path_PLUS_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43154,(0),null);
var fragment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43154,(1),null);
var vec__43157 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(path_PLUS_query,/\?/,(2));
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43157,(1),null);
var G__43160 = reitit.core.match_by_path(routes,path);
if((G__43160 == null)){
return null;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__43160,new cljs.core.Keyword(null,"query-string","query-string",-1018845061),query,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash","hash",-13781596),fragment], 0));
}
});
...
(kee_frame.router.ReititRouter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k43162,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__43166 = k43162;
var G__43166__$1 = (((G__43166 instanceof cljs.core.Keyword))?G__43166.fqn:null);
switch (G__43166__$1) {
case "routes":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k43162,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__43167){
var vec__43168 = p__43167;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43168,(1),null);
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this43163,other43164){
var self__ = this;
var this43163__$1 = this;
return (((!((other43164 == null)))) && ((this43163__$1.constructor === other43164.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43163__$1.routes,other43164.routes)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43163__$1.hash_QMARK_,other43164.hash_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43163__$1.not_found,other43164.not_found)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this43163__$1.__extmap,other43164.__extmap)));
}));
...
var or__4126__auto____$1 = (function (){var G__43173 = self__.not_found;
if((G__43173 == null)){
return null;
} else {
return kee_frame.router.match_url(self__.routes,G__43173);
}
})();
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__43161){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__43174 = cljs.core.keyword_identical_QMARK_;
var expr__43175 = k__4388__auto__;
if(cljs.core.truth_((pred__43174.cljs$core$IFn$_invoke$arity$2 ? pred__43174.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"routes","routes",457900162),expr__43175) : pred__43174.call(null,new cljs.core.Keyword(null,"routes","routes",457900162),expr__43175)))){
return (new kee_frame.router.ReititRouter(G__43161,self__.hash_QMARK_,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43174.cljs$core$IFn$_invoke$arity$2 ? pred__43174.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43175) : pred__43174.call(null,new cljs.core.Keyword(null,"hash?","hash?",-1899275922),expr__43175)))){
return (new kee_frame.router.ReititRouter(self__.routes,G__43161,self__.not_found,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__43174.cljs$core$IFn$_invoke$arity$2 ? pred__43174.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43175) : pred__43174.call(null,new cljs.core.Keyword(null,"not-found","not-found",-629079980),expr__43175)))){
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,G__43161,self__.__meta,self__.__extmap,null));
} else {
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,self__.not_found,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__43161),null));
}
}
}
}));
...
(kee_frame.router.ReititRouter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__43161){
var self__ = this;
var this__4379__auto____$1 = this;
return (new kee_frame.router.ReititRouter(self__.routes,self__.hash_QMARK_,self__.not_found,G__43161,self__.__extmap,self__.__hash));
}));
 ...
 */
kee_frame.router.map__GT_ReititRouter = (function kee_frame$router$map__GT_ReititRouter(G__43165){
var extmap__4419__auto__ = (function (){var G__43177 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__43165,new cljs.core.Keyword(null,"routes","routes",457900162),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hash?","hash?",-1899275922),new cljs.core.Keyword(null,"not-found","not-found",-629079980)], 0));
if(cljs.core.record_QMARK_(G__43165)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__43177);
} else {
return G__43177;
}
})();
return (new kee_frame.router.ReititRouter(new cljs.core.Keyword(null,"routes","routes",457900162).cljs$core$IFn$_invoke$arity$1(G__43165),new cljs.core.Keyword(null,"hash?","hash?",-1899275922).cljs$core$IFn$_invoke$arity$1(G__43165),new cljs.core.Keyword(null,"not-found","not-found",-629079980).cljs$core$IFn$_invoke$arity$1(G__43165),null,cljs.core.not_empty(extmap__4419__auto__),null));
});

kee_frame.router.bootstrap_routes = (function kee_frame$router$bootstrap_routes(p__43179){
...
var routes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43180__$1,new cljs.core.Keyword(null,"routes","routes",457900162));
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43180__$1,new cljs.core.Keyword(null,"router","router",1091916230));
var hash_routing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43180__$1,new cljs.core.Keyword(null,"hash-routing?","hash-routing?",471914732));
var scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43180__$1,new cljs.core.Keyword(null,"scroll","scroll",971553779));
var route_change_event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43180__$1,new cljs.core.Keyword(null,"route-change-event","route-change-event",1834214120));
var not_found = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43180__$1,new cljs.core.Keyword(null,"not-found","not-found",-629079980));
...
var map__43190 = cljs.core.deref(kee_frame.state.debug_config);
...
var routes_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43190__$1,new cljs.core.Keyword(null,"routes?","routes?",-1257506224),true);
...
kee_frame.router.start_BANG_ = (function kee_frame$router$start_BANG_(p__43202){
...
var config = map__43203__$1;
var initial_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"initial-db","initial-db",1939835102));
var debug_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"debug-config","debug-config",329260673));
var routes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"routes","routes",457900162));
var screen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"screen","screen",1990059748));
var router = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"router","router",1091916230));
var app_db_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"app-db-spec","app-db-spec",-1030582586));
var chain_links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"chain-links","chain-links",951542256));
var debug_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43203__$1,new cljs.core.Keyword(null,"debug?","debug?",-1831756173),false);
var scroll = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43203__$1,new cljs.core.Keyword(null,"scroll","scroll",971553779),true);
var root_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43203__$1,new cljs.core.Keyword(null,"root-component","root-component",-1807026475));
...
var config_43283__$1 = ((cljs.core.boolean_QMARK_(screen))?null:screen);
if(cljs.core.truth_(cljs.core.deref(kee_frame.state.breakpoints_initialized_QMARK_))){
kee_frame.interop.set_breakpoint_subs(config_43283__$1);
} else {
kee_frame.interop.set_breakpoints(config_43283__$1);
...
var len__4736__auto___43284 = arguments.length;
var i__4737__auto___43285 = (0);
while(true){
if((i__4737__auto___43285 < len__4736__auto___43284)){
args__4742__auto__.push((arguments[i__4737__auto___43285]));

var G__43286 = (i__4737__auto___43285 + (1));
i__4737__auto___43285 = G__43286;
continue;
} else {
}
break;
