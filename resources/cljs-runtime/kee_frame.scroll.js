...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("kee-frame.scroll","connection-balance","kee-frame.scroll/connection-balance",2106148751),(function (db,p__40061){
var vec__40062 = p__40061;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40062,(0),null);
var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40062,(1),null);
var inc_or_dec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40062,(2),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40065_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("route-interceptor",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__40065_SHARP_));
}),interceptors),(function (){var G__40066 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),"route-interceptor",new cljs.core.Keyword(null,"request","request",1772954723),(function (request){
...
return (ajax.core.to_interceptor.cljs$core$IFn$_invoke$arity$1 ? ajax.core.to_interceptor.cljs$core$IFn$_invoke$arity$1(G__40066) : ajax.core.to_interceptor.call(null,G__40066));
})());
}));
});
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("kee-frame.scroll","poll","kee-frame.scroll/poll",-1227808225),(function (p__40067,p__40068){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40069__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__40070 = p__40068;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40070,(0),null);
var active_route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40070,(1),null);
var counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40070,(2),null);
var map__40074 = new cljs.core.Keyword(null,"route-counter","route-counter",-2049314649).cljs$core$IFn$_invoke$arity$1(db);
...
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40074__$1,new cljs.core.Keyword(null,"route","route",329891309));
var balance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40074__$1,new cljs.core.Keyword(null,"balance","balance",418967409));
