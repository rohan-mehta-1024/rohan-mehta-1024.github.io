...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("kee-frame.scroll","connection-balance","kee-frame.scroll/connection-balance",2106148751),(function (db,p__39996){
var vec__39997 = p__39996;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39997,(0),null);
var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39997,(1),null);
var inc_or_dec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39997,(2),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40002_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("route-interceptor",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__40002_SHARP_));
}),interceptors),(function (){var G__40006 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),"route-interceptor",new cljs.core.Keyword(null,"request","request",1772954723),(function (request){
...
return (ajax.core.to_interceptor.cljs$core$IFn$_invoke$arity$1 ? ajax.core.to_interceptor.cljs$core$IFn$_invoke$arity$1(G__40006) : ajax.core.to_interceptor.call(null,G__40006));
})());
}));
});
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("kee-frame.scroll","poll","kee-frame.scroll/poll",-1227808225),(function (p__40007,p__40008){
var map__40009 = p__40007;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40009__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__40010 = p__40008;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40010,(0),null);
var active_route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40010,(1),null);
var counter = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40010,(2),null);
var map__40015 = new cljs.core.Keyword(null,"route-counter","route-counter",-2049314649).cljs$core$IFn$_invoke$arity$1(db);
...
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40015__$1,new cljs.core.Keyword(null,"route","route",329891309));
var balance = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40015__$1,new cljs.core.Keyword(null,"balance","balance",418967409));
