...
var show_QMARK_ = (cljs.core.truth_(clicked_QMARK_)?"100%":"0%");
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.selectors._GT_.cljs$core$IFn$_invoke$arity$2(garden.selectors._GT_.cljs$core$IFn$_invoke$arity$2((function (){var G__45125 = (garden.selectors.nth_child.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.nth_child.cljs$core$IFn$_invoke$arity$1(id) : garden.selectors.nth_child.call(null,id));
return (personal_website.styles.header_styles.side_nav_stylesheet.side_nav_container_2.cljs$core$IFn$_invoke$arity$1 ? personal_website.styles.header_styles.side_nav_stylesheet.side_nav_container_2.cljs$core$IFn$_invoke$arity$1(G__45125) : personal_website.styles.header_styles.side_nav_stylesheet.side_nav_container_2.call(null,G__45125));
})(),personal_website.styles.header_styles.side_nav_stylesheet.side_nav_elements),personal_website.styles.header_styles.side_nav_stylesheet.side_nav_arrow),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"transform","transform",1381301764),transform,new cljs.core.Keyword(null,"transition","transition",765692007),"transform 0.5s"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.selectors._GT_.cljs$core$IFn$_invoke$arity$2(garden.selectors._GT_.cljs$core$IFn$_invoke$arity$2((function (){var G__45126 = (garden.selectors.nth_child.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.nth_child.cljs$core$IFn$_invoke$arity$1(id) : garden.selectors.nth_child.call(null,id));
return (personal_website.styles.header_styles.side_nav_stylesheet.side_nav_container_2.cljs$core$IFn$_invoke$arity$1 ? personal_website.styles.header_styles.side_nav_stylesheet.side_nav_container_2.cljs$core$IFn$_invoke$arity$1(G__45126) : personal_website.styles.header_styles.side_nav_stylesheet.side_nav_container_2.call(null,G__45126));
...
var handles = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45127_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword("homepage","side-nav-arrow","homepage/side-nav-arrow",2077653864),p1__45127_SHARP_],null));
...
var seq__45128 = cljs.core.seq(handles);
var chunk__45131 = null;
var count__45132 = (0);
var i__45133 = (0);
while(true){
if((i__45133 < count__45132)){
var vec__45147 = chunk__45131.cljs$core$IIndexed$_nth$arity$2(null,i__45133);
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45147,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45147,(1),null);
var handle = vec__45147;
...
var G__45179 = seq__45128;
var G__45180 = chunk__45131;
var G__45181 = count__45132;
var G__45182 = (i__45133 + (1));
seq__45128 = G__45179;
chunk__45131 = G__45180;
count__45132 = G__45181;
i__45133 = G__45182;
continue;
} else {
var G__45183 = seq__45128;
var G__45184 = chunk__45131;
var G__45185 = count__45132;
var G__45186 = (i__45133 + (1));
seq__45128 = G__45183;
chunk__45131 = G__45184;
count__45132 = G__45185;
i__45133 = G__45186;
continue;
}
} else {
...
var c__4556__auto__ = cljs.core.chunk_first(seq__45128__$1);
var G__45187 = cljs.core.chunk_rest(seq__45128__$1);
var G__45188 = c__4556__auto__;
var G__45189 = cljs.core.count(c__4556__auto__);
var G__45190 = (0);
seq__45128 = G__45187;
chunk__45131 = G__45188;
count__45132 = G__45189;
i__45133 = G__45190;
continue;
} else {
var vec__45150 = cljs.core.first(seq__45128__$1);
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45150,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45150,(1),null);
var handle = vec__45150;
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [prefix], null))),id);
if(cljs.core.truth_(val)){
re_frame.core.dispatch(handle);


var G__45191 = cljs.core.next(seq__45128__$1);
var G__45192 = null;
var G__45193 = (0);
var G__45194 = (0);
seq__45128 = G__45191;
chunk__45131 = G__45192;
count__45132 = G__45193;
i__45133 = G__45194;
continue;
} else {
var G__45195 = cljs.core.next(seq__45128__$1);
var G__45196 = null;
var G__45197 = (0);
var G__45198 = (0);
seq__45128 = G__45195;
chunk__45131 = G__45196;
count__45132 = G__45197;
i__45133 = G__45198;
continue;
}
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__4529__auto__ = (function personal_website$styles$header_styles$side_nav_stylesheet$side_nav_selector_$_iter__45164(s__45165){
return (new cljs.core.LazySeq(null,(function (){
var s__45165__$1 = s__45165;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__45165__$1);
if(temp__5735__auto__){
var s__45165__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45165__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__45165__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__45167 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__45166 = (0);
while(true){
if((i__45166 < size__4528__auto__)){
var vec__45170 = cljs.core._nth(c__4527__auto__,i__45166);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45170,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45170,(1),null);
cljs.core.chunk_append(b__45167,personal_website.styles.header_styles.side_nav_stylesheet.side_nav_arrow_selector_skeleton(k,v));

var G__45199 = (i__45166 + (1));
i__45166 = G__45199;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45167),personal_website$styles$header_styles$side_nav_stylesheet$side_nav_selector_$_iter__45164(cljs.core.chunk_rest(s__45165__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45167),null);
}
} else {
var vec__45176 = cljs.core.first(s__45165__$2);
...
return cljs.core.cons(personal_website.styles.header_styles.side_nav_stylesheet.side_nav_arrow_selector_skeleton(k,v),personal_website$styles$header_styles$side_nav_stylesheet$side_nav_selector_$_iter__45164(cljs.core.rest(s__45165__$2)));
}
} else {
return null;
}
