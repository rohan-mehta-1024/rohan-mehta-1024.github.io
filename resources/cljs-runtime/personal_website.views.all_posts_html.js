...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45797 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(split_date,(0));
return (personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1(G__45797) : personal_website.views.all_posts_html.date_mapping.call(null,G__45797));
...
var el_45803 = document.createElement("script");
var set_src_45804 = el_45803.setAttribute("src","https://EXAMPLE.disqus.com/embed.js");
var body_45805 = document.getElementById("body");
...
var post_title = (function (){var fexpr__45799 = (function (){var G__45800 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__45800) : posts.call(null,G__45800));
})();
return (fexpr__45799.cljs$core$IFn$_invoke$arity$1 ? fexpr__45799.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"title","title",636505583)) : fexpr__45799.call(null,new cljs.core.Keyword(null,"title","title",636505583)));
})();
var page_title = personal_website.views.all_posts_html.update_page_title(post_title);
var cssify = personal_website.views.all_posts_html.update_page_css(garden.core.css.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"css","css",1135045163).cljs$core$IFn$_invoke$arity$1((function (){var G__45801 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__45801) : posts.call(null,G__45801));
})())], 0)));
var x = personal_website.views.all_posts_html.load_disqus();
var $ = posts;
var $__$1 = (function (){var G__45802 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return ($.cljs$core$IFn$_invoke$arity$1 ? $.cljs$core$IFn$_invoke$arity$1(G__45802) : $.call(null,G__45802));
})();
