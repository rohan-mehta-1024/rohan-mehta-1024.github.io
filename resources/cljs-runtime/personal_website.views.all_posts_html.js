...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__46250 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(split_date,(0));
return (personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1(G__46250) : personal_website.views.all_posts_html.date_mapping.call(null,G__46250));
...
var post_title = (function (){var fexpr__46252 = (function (){var G__46253 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__46253) : posts.call(null,G__46253));
})();
return (fexpr__46252.cljs$core$IFn$_invoke$arity$1 ? fexpr__46252.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"title","title",636505583)) : fexpr__46252.call(null,new cljs.core.Keyword(null,"title","title",636505583)));
})();
var page_title = personal_website.views.all_posts_html.update_page_title(post_title);
var cssify = personal_website.views.all_posts_html.update_page_css(garden.core.css.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"css","css",1135045163).cljs$core$IFn$_invoke$arity$1((function (){var G__46254 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__46254) : posts.call(null,G__46254));
})())], 0)));
var script = personal_website.views.all_posts_html.load_disqus();
var $ = posts;
var $__$1 = (function (){var G__46255 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return ($.cljs$core$IFn$_invoke$arity$1 ? $.cljs$core$IFn$_invoke$arity$1(G__46255) : $.call(null,G__46255));
})();
