...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__31760 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(split_date,(1));
return (personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1(G__31760) : personal_website.views.all_posts_html.date_mapping.call(null,G__31760));
...
var x_31765 = cljs.core.print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["blogs",personal_website.content.writings.blog_posts.posts.posts], 0));
...
var x = cljs.core.print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["foolish",(params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))),posts], 0));
var a = cljs.core.print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092)))),"shikadai"], 0));
var post_title = (function (){var fexpr__31762 = (function (){var G__31763 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__31763) : posts.call(null,G__31763));
})();
return (fexpr__31762.cljs$core$IFn$_invoke$arity$1 ? fexpr__31762.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"title","title",636505583)) : fexpr__31762.call(null,new cljs.core.Keyword(null,"title","title",636505583)));
})();
var page_title = personal_website.views.all_posts_html.update_page_title(post_title);
var n = cljs.core.print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["ok",post_title], 0));
var $ = posts;
var $__$1 = (function (){var G__31764 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return ($.cljs$core$IFn$_invoke$arity$1 ? $.cljs$core$IFn$_invoke$arity$1(G__31764) : $.call(null,G__31764));
})();
