...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45777 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(split_date,(0));
return (personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.all_posts_html.date_mapping.cljs$core$IFn$_invoke$arity$1(G__45777) : personal_website.views.all_posts_html.date_mapping.call(null,G__45777));
...
var el_45783 = document.createElement("script");
var set_src_45784 = el_45783.setAttribute("src","https://EXAMPLE.disqus.com/embed.js");
var body_45785 = document.getElementById("body");

cljs.core.print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["testing",personal_website.views.all_posts_html.el], 0));

return personal_website.views.all_posts_html.body.appendChild(personal_website.views.all_posts_html.el);
});
...
var post_title = (function (){var fexpr__45779 = (function (){var G__45780 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__45780) : posts.call(null,G__45780));
})();
return (fexpr__45779.cljs$core$IFn$_invoke$arity$1 ? fexpr__45779.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"title","title",636505583)) : fexpr__45779.call(null,new cljs.core.Keyword(null,"title","title",636505583)));
})();
var page_title = personal_website.views.all_posts_html.update_page_title(post_title);
var cssify = personal_website.views.all_posts_html.update_page_css(garden.core.css.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"css","css",1135045163).cljs$core$IFn$_invoke$arity$1((function (){var G__45781 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return (posts.cljs$core$IFn$_invoke$arity$1 ? posts.cljs$core$IFn$_invoke$arity$1(G__45781) : posts.call(null,G__45781));
})())], 0)));
var x = (personal_website.views.all_posts_html.load_.cljs$core$IFn$_invoke$arity$0 ? personal_website.views.all_posts_html.load_.cljs$core$IFn$_invoke$arity$0() : personal_website.views.all_posts_html.load_.call(null));
var $ = posts;
var $__$1 = (function (){var G__45782 = personal_website.utils.unformat_title((params.cljs$core$IFn$_invoke$arity$1 ? params.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092)) : params.call(null,new cljs.core.Keyword(null,"id","id",-1388402092))));
return ($.cljs$core$IFn$_invoke$arity$1 ? $.cljs$core$IFn$_invoke$arity$1(G__45782) : $.call(null,G__45782));
})();
...
var $__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2($__$3,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"script","script",-1304443801),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"src","src",-1651076051),"https://EXAMPLE.disqus.com/embed.js"], null)], null));
var $__$5 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2($__$4,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"disqus_thread"], null)], null));
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2($__$5,personal_website.views.footer_html.footer());
}
}
});
