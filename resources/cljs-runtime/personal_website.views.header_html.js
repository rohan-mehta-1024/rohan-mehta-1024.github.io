...
var first_el = (function (){var fexpr__44766 = (personal_website.views.header_html.subpage_data.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.header_html.subpage_data.cljs$core$IFn$_invoke$arity$1((0)) : personal_website.views.header_html.subpage_data.call(null,(0)));
return (fexpr__44766.cljs$core$IFn$_invoke$arity$1 ? fexpr__44766.cljs$core$IFn$_invoke$arity$1((1)) : fexpr__44766.call(null,(1)));
})();
var in_first_QMARK_ = cljs.core.some((function (p1__44764_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sub_subpage,p1__44764_SHARP_);
}),first_el);
var $ = sub_subpage;
...
var sub_subpage = cljs.core._nth(c__4527__auto__,i__44769);
...
cljs.core.chunk_append(b__44770,personal_website.views.header_html.tooltips_element(el,show_QMARK_,class$,sub_subpage));

var G__44842 = (i__44769 + (1));
i__44769 = G__44842;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44770),personal_website$views$header_html$tooltips_$_iter__44767(cljs.core.chunk_rest(s__44768__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44770),null);
}
} else {
var sub_subpage = cljs.core.first(s__44768__$2);
var placeholder_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sub_subpage,"placeholder");
var show_QMARK_ = ((placeholder_QMARK_)?"0%":"100%");
var el = ((placeholder_QMARK_)?new cljs.core.Keyword(null,"div","div",1057191632):new cljs.core.Keyword(null,"a","a",-2123407586));
var class$ = ((placeholder_QMARK_)?"":"subpage-tooltip-elements");
var link = ((placeholder_QMARK_)?"":personal_website.views.header_html.format_url(sub_subpage));
return cljs.core.cons(personal_website.views.header_html.tooltips_element(el,show_QMARK_,class$,sub_subpage),personal_website$views$header_html$tooltips_$_iter__44767(cljs.core.rest(s__44768__$2)));
}
} else {
return null;
}
...
var vec__44799 = cljs.core._nth(c__4527__auto__,i__44797);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44799,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44799,(1),null);
cljs.core.chunk_append(b__44798,personal_website.views.header_html.subpage_skeleton(text,id));

var G__44847 = (i__44797 + (1));
i__44797 = G__44847;
continue;
} else {
return true;
...
var vec__44802 = cljs.core.first(s__44796__$2);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44802,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44802,(1),null);
...
var seq__44805_44848 = cljs.core.seq(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"2","2",-1645882217),new cljs.core.Keyword(null,"3","3",2097825370),new cljs.core.Keyword(null,"4","4",-1197948085),new cljs.core.Keyword(null,"5","5",538911032)], null));
var chunk__44807_44849 = null;
var count__44808_44850 = (0);
var i__44809_44851 = (0);
while(true){
if((i__44809_44851 < count__44808_44850)){
var key_44852 = chunk__44807_44849.cljs$core$IIndexed$_nth$arity$2(null,i__44809_44851);
if(cljs.core.truth_((function (){var and__4115__auto__ = (mapping.cljs$core$IFn$_invoke$arity$1 ? mapping.cljs$core$IFn$_invoke$arity$1(key_44852) : mapping.call(null,key_44852));
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(key_44852,given_idx);
} else {
return and__4115__auto__;
}
})())){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("homepage","side-nav-arrow","homepage/side-nav-arrow",2077653864),key_44852], null));


var G__44853 = seq__44805_44848;
var G__44854 = chunk__44807_44849;
var G__44855 = count__44808_44850;
var G__44856 = (i__44809_44851 + (1));
seq__44805_44848 = G__44853;
chunk__44807_44849 = G__44854;
count__44808_44850 = G__44855;
i__44809_44851 = G__44856;
continue;
} else {
var G__44857 = seq__44805_44848;
var G__44858 = chunk__44807_44849;
var G__44859 = count__44808_44850;
var G__44860 = (i__44809_44851 + (1));
seq__44805_44848 = G__44857;
chunk__44807_44849 = G__44858;
count__44808_44850 = G__44859;
i__44809_44851 = G__44860;
continue;
}
} else {
var temp__5735__auto___44861 = cljs.core.seq(seq__44805_44848);
if(temp__5735__auto___44861){
var seq__44805_44862__$1 = temp__5735__auto___44861;
if(cljs.core.chunked_seq_QMARK_(seq__44805_44862__$1)){
var c__4556__auto___44863 = cljs.core.chunk_first(seq__44805_44862__$1);
var G__44864 = cljs.core.chunk_rest(seq__44805_44862__$1);
var G__44865 = c__4556__auto___44863;
var G__44866 = cljs.core.count(c__4556__auto___44863);
var G__44867 = (0);
seq__44805_44848 = G__44864;
chunk__44807_44849 = G__44865;
count__44808_44850 = G__44866;
i__44809_44851 = G__44867;
continue;
} else {
var key_44872 = cljs.core.first(seq__44805_44862__$1);
...
var G__44873 = cljs.core.next(seq__44805_44862__$1);
var G__44874 = null;
var G__44875 = (0);
var G__44876 = (0);
seq__44805_44848 = G__44873;
chunk__44807_44849 = G__44874;
count__44808_44850 = G__44875;
i__44809_44851 = G__44876;
continue;
} else {
var G__44877 = cljs.core.next(seq__44805_44862__$1);
var G__44878 = null;
var G__44879 = (0);
var G__44880 = (0);
seq__44805_44848 = G__44877;
chunk__44807_44849 = G__44878;
count__44808_44850 = G__44879;
i__44809_44851 = G__44880;
continue;
}
}
} else {
...
var G__44881 = (i__44830 + (1));
i__44830 = G__44881;
continue;
} else {
var G__44882 = (i__44830 + (1));
i__44830 = G__44882;
continue;
}
} else {
...
var G__44883 = cljs.core.rest(s__44829__$2);
s__44829__$1 = G__44883;
continue;
}
}
} else {
