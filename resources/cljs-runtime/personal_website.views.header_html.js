...
var first_el = (function (){var fexpr__31775 = (personal_website.views.header_html.subpage_data.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.header_html.subpage_data.cljs$core$IFn$_invoke$arity$1((0)) : personal_website.views.header_html.subpage_data.call(null,(0)));
return (fexpr__31775.cljs$core$IFn$_invoke$arity$1 ? fexpr__31775.cljs$core$IFn$_invoke$arity$1((1)) : fexpr__31775.call(null,(1)));
})();
var in_first_QMARK_ = cljs.core.some((function (p1__31774_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sub_subpage,p1__31774_SHARP_);
}),first_el);
var $ = sub_subpage;
...
var sub_subpage = cljs.core._nth(c__4527__auto__,i__31778);
...
cljs.core.chunk_append(b__31779,personal_website.views.header_html.tooltips_element(el,show_QMARK_,class$,sub_subpage));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31779),personal_website$views$header_html$tooltips_$_iter__31776(cljs.core.chunk_rest(s__31777__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31779),null);
}
} else {
var sub_subpage = cljs.core.first(s__31777__$2);
var placeholder_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sub_subpage,"placeholder");
var show_QMARK_ = ((placeholder_QMARK_)?"0%":"100%");
var el = ((placeholder_QMARK_)?new cljs.core.Keyword(null,"div","div",1057191632):new cljs.core.Keyword(null,"a","a",-2123407586));
var class$ = ((placeholder_QMARK_)?"":"subpage-tooltip-elements");
var link = ((placeholder_QMARK_)?"":personal_website.views.header_html.format_url(sub_subpage));
return cljs.core.cons(personal_website.views.header_html.tooltips_element(el,show_QMARK_,class$,sub_subpage),personal_website$views$header_html$tooltips_$_iter__31776(cljs.core.rest(s__31777__$2)));
}
} else {
return null;
}
...
var $ = (function (){var iter__4529__auto__ = (function personal_website$views$header_html$subpages_$_iter__31780(s__31781){
return (new cljs.core.LazySeq(null,(function (){
var s__31781__$1 = s__31781;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__31781__$1);
if(temp__5735__auto__){
var s__31781__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31781__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__31781__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__31783 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__31782 = (0);
while(true){
if((i__31782 < size__4528__auto__)){
var vec__31784 = cljs.core._nth(c__4527__auto__,i__31782);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31784,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31784,(1),null);
cljs.core.chunk_append(b__31783,personal_website.views.header_html.subpage_skeleton(text,id));

var G__31813 = (i__31782 + (1));
i__31782 = G__31813;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31783),personal_website$views$header_html$subpages_$_iter__31780(cljs.core.chunk_rest(s__31781__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31783),null);
}
} else {
var vec__31787 = cljs.core.first(s__31781__$2);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31787,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31787,(1),null);
return cljs.core.cons(personal_website.views.header_html.subpage_skeleton(text,id),personal_website$views$header_html$subpages_$_iter__31780(cljs.core.rest(s__31781__$2)));
}
} else {
return null;
}
...
var seq__31790_31815 = cljs.core.seq(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"2","2",-1645882217),new cljs.core.Keyword(null,"3","3",2097825370),new cljs.core.Keyword(null,"4","4",-1197948085),new cljs.core.Keyword(null,"5","5",538911032)], null));
var chunk__31792_31816 = null;
var count__31793_31817 = (0);
var i__31794_31818 = (0);
while(true){
if((i__31794_31818 < count__31793_31817)){
var key_31821 = chunk__31792_31816.cljs$core$IIndexed$_nth$arity$2(null,i__31794_31818);
if(cljs.core.truth_((function (){var and__4115__auto__ = (mapping.cljs$core$IFn$_invoke$arity$1 ? mapping.cljs$core$IFn$_invoke$arity$1(key_31821) : mapping.call(null,key_31821));
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(key_31821,given_idx);
} else {
return and__4115__auto__;
}
})())){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("homepage","side-nav-arrow","homepage/side-nav-arrow",2077653864),key_31821], null));


var G__31823 = seq__31790_31815;
var G__31824 = chunk__31792_31816;
var G__31825 = count__31793_31817;
var G__31826 = (i__31794_31818 + (1));
seq__31790_31815 = G__31823;
chunk__31792_31816 = G__31824;
count__31793_31817 = G__31825;
i__31794_31818 = G__31826;
continue;
} else {
var G__31827 = seq__31790_31815;
var G__31828 = chunk__31792_31816;
var G__31829 = count__31793_31817;
var G__31830 = (i__31794_31818 + (1));
seq__31790_31815 = G__31827;
chunk__31792_31816 = G__31828;
count__31793_31817 = G__31829;
i__31794_31818 = G__31830;
continue;
}
} else {
var temp__5735__auto___31831 = cljs.core.seq(seq__31790_31815);
if(temp__5735__auto___31831){
var seq__31790_31832__$1 = temp__5735__auto___31831;
if(cljs.core.chunked_seq_QMARK_(seq__31790_31832__$1)){
var c__4556__auto___31833 = cljs.core.chunk_first(seq__31790_31832__$1);
var G__31834 = cljs.core.chunk_rest(seq__31790_31832__$1);
var G__31835 = c__4556__auto___31833;
var G__31836 = cljs.core.count(c__4556__auto___31833);
var G__31837 = (0);
seq__31790_31815 = G__31834;
chunk__31792_31816 = G__31835;
count__31793_31817 = G__31836;
i__31794_31818 = G__31837;
continue;
} else {
var key_31839 = cljs.core.first(seq__31790_31832__$1);
if(cljs.core.truth_((function (){var and__4115__auto__ = (mapping.cljs$core$IFn$_invoke$arity$1 ? mapping.cljs$core$IFn$_invoke$arity$1(key_31839) : mapping.call(null,key_31839));
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(key_31839,given_idx);
} else {
return and__4115__auto__;
}
})())){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("homepage","side-nav-arrow","homepage/side-nav-arrow",2077653864),key_31839], null));


var G__31840 = cljs.core.next(seq__31790_31832__$1);
var G__31841 = null;
var G__31842 = (0);
var G__31843 = (0);
seq__31790_31815 = G__31840;
chunk__31792_31816 = G__31841;
count__31793_31817 = G__31842;
i__31794_31818 = G__31843;
continue;
} else {
var G__31844 = cljs.core.next(seq__31790_31832__$1);
var G__31845 = null;
var G__31846 = (0);
var G__31847 = (0);
seq__31790_31815 = G__31844;
chunk__31792_31816 = G__31845;
count__31793_31817 = G__31846;
i__31794_31818 = G__31847;
continue;
}
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31799),personal_website$views$header_html$side_nav_arrow_subpages_$_iter__31796(cljs.core.chunk_rest(s__31797__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31799),null);
}
} else {
var sub_subpage = cljs.core.first(s__31797__$2);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(sub_subpage,"placeholder")){
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"side-nav-subpage-elements",new cljs.core.Keyword(null,"href","href",-793805698),personal_website.views.header_html.format_url(sub_subpage),new cljs.core.Keyword(null,"on-click","on-click",1632826543),close__$1], null),sub_subpage], null),personal_website$views$header_html$side_nav_arrow_subpages_$_iter__31796(cljs.core.rest(s__31797__$2)));
} else {
var G__31850 = cljs.core.rest(s__31797__$2);
s__31797__$1 = G__31850;
continue;
}
}
} else {
...
var $ = (function (){var iter__4529__auto__ = (function personal_website$views$header_html$side_nav_$_iter__31800(s__31801){
return (new cljs.core.LazySeq(null,(function (){
var s__31801__$1 = s__31801;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__31801__$1);
if(temp__5735__auto__){
var s__31801__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31801__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__31801__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__31803 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__31802 = (0);
while(true){
if((i__31802 < size__4528__auto__)){
var vec__31804 = cljs.core._nth(c__4527__auto__,i__31802);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31804,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31804,(1),null);
cljs.core.chunk_append(b__31803,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.cons(new cljs.core.Keyword(null,"ul","ul",-1349521403),cljs.core.cons(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"side-nav-container-2"], null),personal_website.views.header_html.side_nav_skeleton(text,id)))));

var G__31851 = (i__31802 + (1));
i__31802 = G__31851;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31803),personal_website$views$header_html$side_nav_$_iter__31800(cljs.core.chunk_rest(s__31801__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31803),null);
}
} else {
var vec__31807 = cljs.core.first(s__31801__$2);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31807,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31807,(1),null);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.cons(new cljs.core.Keyword(null,"ul","ul",-1349521403),cljs.core.cons(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"side-nav-container-2"], null),personal_website.views.header_html.side_nav_skeleton(text,id)))),personal_website$views$header_html$side_nav_$_iter__31800(cljs.core.rest(s__31801__$2)));
}
} else {
return null;
}
