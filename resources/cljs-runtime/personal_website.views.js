...
personal_website.views.route_view_mapping = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"homepage","homepage",-1646828249),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [personal_website.views.homepage_views.homepage_html.homepage_html], null),new cljs.core.Keyword(null,"blog-posts","blog-posts",2099061283),personal_website.views.all_posts_html.display], null);
...
return personal_website.views.update_page_css(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(text_css,garden.core.css,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vendors","vendors",-153040496),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["webkit"], null),new cljs.core.Keyword(null,"autoprefix","autoprefix",1203504337),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transition","transition",765692007),null], null), null)], null)));
});
...
}),new cljs.core.Keyword(null,"homepage","homepage",-1646828249),(personal_website.views.route_view_mapping.cljs$core$IFn$_invoke$arity$1 ? personal_website.views.route_view_mapping.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"homepage","homepage",-1646828249)) : personal_website.views.route_view_mapping.call(null,new cljs.core.Keyword(null,"homepage","homepage",-1646828249))),new cljs.core.Keyword(null,"syn-bio","syn-bio",-1893273080),personal_website.views.all_posts_html.display,new cljs.core.Keyword(null,"comp-sci","comp-sci",-1030545072),personal_website.views.all_posts_html.display,new cljs.core.Keyword(null,"blog-posts","blog-posts",2099061283),personal_website.views.all_posts_html.display,new cljs.core.Keyword(null,"essays","essays",-1695424907),personal_website.views.all_posts_html.display,new cljs.core.Keyword(null,"stories","stories",-1910187794),personal_website.views.all_posts_html.display,new cljs.core.Keyword(null,"poems","poems",-1901766320),personal_website.views.all_posts_html.display,new cljs.core.Keyword(null,"papers","papers",1152250078),personal_website.views.all_posts_html.display,null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [personal_website.views.homepage_views.homepage_html.homepage_html], null)], null);
});
