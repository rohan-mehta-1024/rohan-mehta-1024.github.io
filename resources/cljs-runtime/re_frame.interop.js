...
return [(function (){var pred__36902 = cljs.core.instance_QMARK_;
var expr__36903 = reactive_val;
if(cljs.core.truth_((pred__36902.cljs$core$IFn$_invoke$arity$2 ? pred__36902.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__36903) : pred__36902.call(null,reagent.ratom.RAtom,expr__36903)))){
return "ra";
} else {
if(cljs.core.truth_((pred__36902.cljs$core$IFn$_invoke$arity$2 ? pred__36902.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__36903) : pred__36902.call(null,reagent.ratom.RCursor,expr__36903)))){
return "rc";
} else {
if(cljs.core.truth_((pred__36902.cljs$core$IFn$_invoke$arity$2 ? pred__36902.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__36903) : pred__36902.call(null,reagent.ratom.Reaction,expr__36903)))){
return "rx";
} else {
if(cljs.core.truth_((pred__36902.cljs$core$IFn$_invoke$arity$2 ? pred__36902.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__36903) : pred__36902.call(null,reagent.ratom.Track,expr__36903)))){
return "tr";
} else {
return "other";
}
