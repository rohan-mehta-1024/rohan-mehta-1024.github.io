...
return (re_frame.interop.after_render.cljs$core$IFn$_invoke$arity$1 ? re_frame.interop.after_render.cljs$core$IFn$_invoke$arity$1(G__37643) : re_frame.interop.after_render.call(null,G__37643));
...
var re_frame$router$IEventQueue$push$dyn_37690 = (function (this$,event){
...
return re_frame$router$IEventQueue$push$dyn_37690(this$,event);
}
});

var re_frame$router$IEventQueue$add_post_event_callback$dyn_37699 = (function (this$,id,callack){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$add_post_event_callback$dyn_37699(this$,id,callack);
}
});

var re_frame$router$IEventQueue$remove_post_event_callback$dyn_37729 = (function (this$,f){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$remove_post_event_callback$dyn_37729(this$,f);
}
});
...
var re_frame$router$IEventQueue$_fsm_trigger$dyn_37745 = (function (this$,trigger,arg){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_fsm_trigger$dyn_37745(this$,trigger,arg);
}
});
...
var re_frame$router$IEventQueue$_process_1st_event_in_queue$dyn_37753 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_process_1st_event_in_queue$dyn_37753(this$);
}
});

var re_frame$router$IEventQueue$_run_next_tick$dyn_37758 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_next_tick$dyn_37758(this$);
}
});

var re_frame$router$IEventQueue$_run_queue$dyn_37759 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_run_queue$dyn_37759(this$);
}
});

var re_frame$router$IEventQueue$_exception$dyn_37760 = (function (this$,ex){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_exception$dyn_37760(this$,ex);
}
});

var re_frame$router$IEventQueue$_pause$dyn_37761 = (function (this$,later_fn){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_pause$dyn_37761(this$,later_fn);
}
});

var re_frame$router$IEventQueue$_resume$dyn_37766 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_resume$dyn_37766(this$);
}
});

var re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_37767 = (function (this$,event){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return re_frame$router$IEventQueue$_call_post_event_callbacks$dyn_37767(this$,event);
}
});
...
return (re_frame.interop.next_tick.cljs$core$IFn$_invoke$arity$1 ? re_frame.interop.next_tick.cljs$core$IFn$_invoke$arity$1(G__37664) : re_frame.interop.next_tick.call(null,G__37664));
}));
...
var _STAR_current_trace_STAR__orig_val__37665 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__37666 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("re-frame.router","fsm-trigger","re-frame.router/fsm-trigger",1379787274)], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__37666);

try{try{var vec__37671 = (function (){var G__37674 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null);
...
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__37665);
}} else {
var vec__37677 = (function (){var G__37680 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"exception","exception",-335277064)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861),(function (){
return this$__$1.re_frame$router$IEventQueue$_exception$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"finish-run","finish-run",753148477)], null),G__37680)){
if(cljs.core.empty_QMARK_(self__.queue)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idle","idle",-2007156861)], null);
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"pause","pause",-2095325672)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),(function (){
return this$__$1.re_frame$router$IEventQueue$_pause$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"resume","resume",-118572261)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_resume$arity$1(null);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"run-queue","run-queue",-1701798027)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_run_queue$arity$1(null);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"paused","paused",-1710376127),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"running","running",1554969103),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),new cljs.core.Keyword(null,"add-event","add-event",938429088)], null),G__37680)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"scheduled","scheduled",553898551),(function (){
return this$__$1.re_frame$router$IEventQueue$_add_event$arity$2(null,arg);
})], null);
} else {
...
var new_fsm_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37677,(0),null);
var action_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37677,(1),null);
if(re_frame.trace.is_trace_enabled_QMARK_()){
var new_trace__37423__auto___37841 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.update.cljs$core$IFn$_invoke$arity$4(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.merge,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"operation","operation",-1267664310),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null),new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"current-state","current-state",1048284452),self__.fsm_state,new cljs.core.Keyword(null,"new-state","new-state",-490349212),new_fsm_state], null)], null))),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"operation","operation",-1267664310),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [self__.fsm_state,trigger], null),new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"current-state","current-state",1048284452),self__.fsm_state,new cljs.core.Keyword(null,"new-state","new-state",-490349212),new_fsm_state], null)], null),new cljs.core.Keyword(null,"tags","tags",1771418977))], 0));
(re_frame.trace._STAR_current_trace_STAR_ = new_trace__37423__auto___37841);
...
var G__37852 = seq__37684;
var G__37853 = chunk__37685;
var G__37854 = count__37686;
var G__37855 = (i__37687 + (1));
seq__37684 = G__37852;
chunk__37685 = G__37853;
count__37686 = G__37854;
i__37687 = G__37855;
continue;
} else {
...
var G__37883 = cljs.core.chunk_rest(seq__37684__$1);
var G__37884 = c__4556__auto__;
var G__37885 = cljs.core.count(c__4556__auto__);
var G__37886 = (0);
seq__37684 = G__37883;
chunk__37685 = G__37884;
count__37686 = G__37885;
i__37687 = G__37886;
continue;
} else {
...
var G__37891 = cljs.core.next(seq__37684__$1);
var G__37892 = null;
var G__37893 = (0);
var G__37894 = (0);
seq__37684 = G__37891;
chunk__37685 = G__37892;
count__37686 = G__37893;
i__37687 = G__37894;
continue;
}
} else {
