...
if((i < len)){
var k = (ks[i]);
var G__36680 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36681 = (i + (1));
m = G__36680;
i = G__36681;
continue;
...
var G__36662 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36662) : reagent.impl.component.as_element.call(null,G__36662));
};
...
while (G__36689__i < G__36689__a.length) {G__36689__a[G__36689__i] = arguments[G__36689__i + 0]; ++G__36689__i;}
  args = new cljs.core.IndexedSeq(G__36689__a,0,null);
} 
return G__36687__delegate.call(this,args);};
G__36687.cljs$lang$maxFixedArity = 0;
G__36687.cljs$lang$applyTo = (function (arglist__36690){
var args = cljs.core.seq(arglist__36690);
...
var c = this;
var G__36675_36713 = goog.object.get(c,"cljsRatom");
if((G__36675_36713 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36675_36713);
}
...
var renders_36715 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36716 = cljs.core.first(cljs.core.vals(renders_36715));
...
if((cljs.core.count(renders_36715) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36715))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36716)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36716], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
