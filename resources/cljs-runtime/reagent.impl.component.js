...
if((i < len)){
var k = (ks[i]);
var G__36715 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36716 = (i + (1));
m = G__36715;
i = G__36716;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36651 = c;
var G__36651__$1 = (((G__36651 == null))?null:G__36651.prototype);
if((G__36651__$1 == null)){
return null;
} else {
return G__36651__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36656 = c;
var G__36656__$1 = (((G__36656 == null))?null:G__36656.prototype);
if((G__36656__$1 == null)){
return null;
} else {
return G__36656__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__36743__delegate = function (args){
var G__36658 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36658) : reagent.impl.component.as_element.call(null,G__36658));
};
...
while (G__36744__i < G__36744__a.length) {G__36744__a[G__36744__i] = arguments[G__36744__i + 0]; ++G__36744__i;}
  args = new cljs.core.IndexedSeq(G__36744__a,0,null);
} 
return G__36743__delegate.call(this,args);};
G__36743.cljs$lang$maxFixedArity = 0;
G__36743.cljs$lang$applyTo = (function (arglist__36745){
var args = cljs.core.seq(arglist__36745);
return G__36743__delegate(args);
});
...
var G__36663 = c;
var G__36663__$1 = (((G__36663 == null))?null:G__36663.constructor);
if((G__36663__$1 == null)){
return null;
} else {
return G__36663__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__36664 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36665 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36665);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36664);
}});
...
var c = this;
var G__36674_36757 = goog.object.get(c,"cljsRatom");
if((G__36674_36757 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36674_36757);
}
...
var renders_36762 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36763 = cljs.core.first(cljs.core.vals(renders_36762));
...
if((cljs.core.count(renders_36762) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36762))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36763)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36763], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
