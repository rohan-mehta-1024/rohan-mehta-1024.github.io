...
if((i < len)){
var k = (ks[i]);
var G__36711 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36712 = (i + (1));
m = G__36711;
i = G__36712;
continue;
...
var G__36660 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36660) : reagent.impl.component.as_element.call(null,G__36660));
};
...
while (G__36719__i < G__36719__a.length) {G__36719__a[G__36719__i] = arguments[G__36719__i + 0]; ++G__36719__i;}
  args = new cljs.core.IndexedSeq(G__36719__a,0,null);
} 
...
var G__36661 = c;
var G__36661__$1 = (((G__36661 == null))?null:G__36661.constructor);
if((G__36661__$1 == null)){
return null;
} else {
return G__36661__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__36662 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36663 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36663);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36662);
}});
...
var G__36666 = key;
var G__36666__$1 = (((G__36666 instanceof cljs.core.Keyword))?G__36666.fqn:null);
switch (G__36666__$1) {
...
var c = this;
var G__36677_36725 = goog.object.get(c,"cljsRatom");
if((G__36677_36725 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36677_36725);
}
...
var renders_36727 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36728 = cljs.core.first(cljs.core.vals(renders_36727));
...
if((cljs.core.count(renders_36727) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36727))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36728)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36728], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
