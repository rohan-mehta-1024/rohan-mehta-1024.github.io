...
var G__36801 = o;
goog.object.set(G__36801,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__36829__i < G__36829__a.length) {G__36829__a[G__36829__i] = arguments[G__36829__i + 0]; ++G__36829__i;}
  args = new cljs.core.IndexedSeq(G__36829__a,0,null);
} 
...
var G__36803 = o;
goog.object.set(G__36803,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__36806 = props;
var G__36806__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36806,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36806);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36806__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__36806__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36807 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36807,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36807;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36808){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36809__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__36811_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36811_SHARP_);
}));
} else {
return null;
}
...
var vec__36813 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36813,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36813,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36813,(2),null);
...
var temp__5739__auto___36845 = reagent.impl.template.key_from_vec(v);
...
var temp__5739__auto___36848 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36848 == null)){
} else {
var key_36849 = temp__5739__auto___36848;
...
var G__36817 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36817) : reagent.impl.template.as_element.call(null,G__36817));
} else {
var temp__5739__auto___36861 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___36861 == null)){
} else {
var key_36869 = temp__5739__auto___36861;
(jsprops.key = key_36869);
}
...
var G__36819 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__36819)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__36819)){
return x;
} else {
...
var len__4736__auto___36877 = arguments.length;
var i__4737__auto___36878 = (0);
while(true){
if((i__4737__auto___36878 < len__4736__auto___36877)){
args__4742__auto__.push((arguments[i__4737__auto___36878]));

var G__36880 = (i__4737__auto___36878 + (1));
i__4737__auto___36878 = G__36880;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36820){
var G__36821 = cljs.core.first(seq36820);
var seq36820__$1 = cljs.core.next(seq36820);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36821,seq36820__$1);
}));
...
break;
default:
var G__36887 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36887;
continue;
...
var ctx = ({});
var vec__36824 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36824,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36824,(1),null);
...
var G__36827 = (cljs.core.count(argv) - first_child);
switch (G__36827) {
case (0):
