...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35473 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35473(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35479 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35479(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35480 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35480(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35481 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35481(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35482 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35482(runtime,input,callback);
}
});
...
shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35470,callback){
...
var input = map__35471__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35471__$1,new cljs.core.Keyword(null,"code","code",1586293142));
