...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35503 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35503(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35504 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35504(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35505 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35505(runtime,key);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35514 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35514(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35484,callback){
...
var input = map__35485__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35485__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35485__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
