...
(def post
  {:title "ML Algorithms From Scratch In Clojure"
   ...
   :show "Well, not from scratch scratch, but pretty much. A reacclimation to differentiable
          programming at its simplest – and finest – in a beautiful functional language."
   :tags ["this", "that", "FSms"]
