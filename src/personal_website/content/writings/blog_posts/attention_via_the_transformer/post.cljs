(ns personal-website.content.writings.blog-posts.attention-via-the-transformer.post
...
[:p "Before we delve further into how the transformer phrases self-attention mathematically though,
     ...
     text they are fed and to work with longer, more complicated text while still being capable of similar comprehension."]

  [:img {:src "self_attention.jpg"}]
