 ...
 [:figure {:class "img-container"}
  ...
  [:p "This process of caching the current derivative
   ...
   [:p "It's worth noting though that things aren't always this simple.
        ...
        each node. But as more complex architectures adding things
        lie skip connections and recurrence we can get"]
        [:figure {:class "img-container"}
         [:div {:style {:text-align "center"}}
   ...
   [:p "If we consider the graph above we can see such an example."]
