window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=91c6c1&fwbuild=dev"};
...
document.write('<script>goog.require("mysite.js.header");</script>');
