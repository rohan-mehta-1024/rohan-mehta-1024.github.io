...
var len__4736__auto___15470 = arguments.length;
var i__4737__auto___15471 = (0);
while(true){
if((i__4737__auto___15471 < len__4736__auto___15470)){
args__4742__auto__.push((arguments[i__4737__auto___15471]));

var G__15472 = (i__4737__auto___15471 + (1));
i__4737__auto___15471 = G__15472;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15467){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15468,G__15469,seq15467__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15473_SHARP_){
return (!((cljs.core.meta.call(null,p1__15473_SHARP_) == null)));
})))){
...
var map__15474 = opts;
var map__15474__$1 = (((((!((map__15474 == null))))?(((((map__15474.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15474.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15474):map__15474);
var markup_db = cljs.core.get.call(null,map__15474__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15478){var _e__14450__auto__ = e15478;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e15480){var _e__14450__auto__ = e15480;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15482 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15483 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15483);

try{var map__15484 = opts;
var map__15484__$1 = (((((!((map__15484 == null))))?(((((map__15484.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15484.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15484):map__15484);
var markup_db = cljs.core.get.call(null,map__15484__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15482);
}});
...
var temp__5455__auto___15489 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___15489)){
var managed_print_level_15490 = temp__5455__auto___15489;
var _STAR_print_level_STAR__orig_val__15487_15491 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15488_15492 = managed_print_level_15490;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15488_15492);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__15486_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15486_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15487_15491);
}} else {
job_fn.call(null);
}
