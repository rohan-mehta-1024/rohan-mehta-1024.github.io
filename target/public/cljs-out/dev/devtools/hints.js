...
}catch (e11605){var _e = e11605;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___11608 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___11608)){
var seen_errors_11609 = temp__5455__auto___11608;
if(cljs.core.truth_(seen_errors_11609.has(self))){
} else {
seen_errors_11609.add(self);

var temp__5457__auto___11610 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___11610)){
var sense_11611 = temp__5457__auto___11610;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11611)].join(''));
} else {
}
}
} else {
